...
- **Keyboard navigation:** Left / Right move through the selected game or sideline, including after clicking the board or panel controls. Manual navigation pauses playback. Text entry, dialogs, and retry exercises keep their own controls.
